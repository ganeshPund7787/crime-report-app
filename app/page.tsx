      ...
      <main className="relative px-6 pt-32">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="inline-flex h-9 items-center gap-2 rounded-full border border-cyan-500/20 bg-cyan-500/10 px-4 text-sm text-cyan-400">
              <svg
                className="h-4 w-4"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              <Link href={"/submit-report"}>
                <button className="group relative flex h-12 items-center justify-center gap-2 rounded-xl bg-cyan-500 px-8 text-sm font-medium text-white transition-all hover:bg-cyan-400">
